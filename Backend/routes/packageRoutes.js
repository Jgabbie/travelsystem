...
router.post('/archived-packages/:packageItem/restore', userAuth, packageController.restoreArchivedPackage);
router.get('/get-packages-for-users', packageController.getPackagesForUsers);
router.delete('/remove-package/:packageItem', userAuth, packageController.removePackage);
